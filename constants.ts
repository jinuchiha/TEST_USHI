...
export const ICONS = {
    ...
    mapPin: (className: string) => React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", className, fill: "none", viewBox: "0 0 24 24", strokeWidth: 1.5, stroke: "currentColor" }, React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" }), React.createElement("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" })),
};
...
export const SIDEBAR_NAV_ITEMS: NavItem[] = [
    ...
    { label: 'Team Floor', view: 'team-floor', icon: ICONS.team, roles: [Role.OFFICER] },
    { label: 'New Allocations', view: 'new-allocations', icon: ICONS.plus, roles: [Role.OFFICER] },
    ...
    { label: 'Skip Tracing (PK)', view: 'pk-tracing', icon: ICONS.search, roles: [Role.OFFICER] },
    { label: 'AI Recovery Coach', view: 'recovery-coach', icon: ICONS.lightbulb, roles: [Role.OFFICER] },
    { label: 'Voice Call Studio', view: 'voice-studio', icon: ICONS.phone, roles: [Role.OFFICER] },
    { label: 'Crystal Ball 🔮', view: 'crystal-ball', icon: ICONS.eye, roles: [Role.OFFICER] },
    { label: 'My XP & Badges 🏆', view: 'officer-xp', icon: ICONS.performance, roles: [Role.OFFICER] },
    { label: 'Negotiation Simulator', view: 'negotiation-sim', icon: ICONS.activities, roles: [Role.OFFICER] },
    { label: 'Recall Engine', view: 'recall-engine', icon: ICONS.bell, roles: [Role.OFFICER] },
    { label: 'Bulk Send', view: 'bulk-comms', icon: ICONS.email, roles: [Role.OFFICER] },
    ...
    { label: 'Search Cases', view: 'search', icon: ICONS.search, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Skip Tracing (PK)', view: 'pk-tracing', icon: ICONS.search, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Recall Engine', view: 'recall-engine', icon: ICONS.bell, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Connected Debtors', view: 'connected-debtors', icon: ICONS.filter, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Bulk Send', view: 'bulk-comms', icon: ICONS.email, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Pipeline Board', view: 'kanban', icon: ICONS.filter, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Team Allocation', view: 'team', icon: ICONS.team, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Pending Withdrawals', view: 'pending-withdrawals', icon: ICONS.archive, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Withdrawn Cases', view: 'withdrawn-cases', icon: ICONS.archive, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Field Visits', view: 'field-visits', icon: ICONS.mapPin, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Bank Drafts', view: 'bank-drafts', icon: ICONS.payment, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Reports', view: '', isHeading: true, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Summary Report', view: 'summary-report', icon: ICONS.performance, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Status Matrix', view: 'status-matrix', icon: ICONS.filter, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Allocation Report', view: 'allocation-report', icon: ICONS.documentReport, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Annual Forecast', view: 'annual-forecast', icon: ICONS.documentReport, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Day-End Report', view: 'daily-report', icon: ICONS.documentReport, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Promise Dashboard', view: 'promise-dashboard', icon: ICONS.calendar, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Analytics', view: '', isHeading: true, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'AI Insights', view: 'ai-insights', icon: ICONS.performance, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Vintage Analyzer', view: 'vintage-ai', icon: ICONS.lightbulb, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'AI Case Intake', view: 'case-intake', icon: ICONS.plus, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Bank Intelligence', view: 'bank-intel', icon: ICONS.payment, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Negotiation Simulator', view: 'negotiation-sim', icon: ICONS.activities, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Crystal Ball 🔮', view: 'crystal-ball', icon: ICONS.eye, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Family Network 🕸️', view: 'family-network', icon: ICONS.team, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Voice Call Studio', view: 'voice-studio', icon: ICONS.phone, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Team XP Leaderboard 🏆', view: 'officer-xp', icon: ICONS.performance, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Portfolio Intelligence', view: 'portfolio-intelligence', icon: ICONS.filter, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Portfolio Aging (AI)', view: 'portfolio-aging-ai', icon: ICONS.export, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Team Leaderboard', view: 'productivity', icon: ICONS.performance, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'People', view: '', isHeading: true, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'User Management', view: 'users', icon: ICONS.team, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Team Floor', view: 'team-floor', icon: ICONS.team, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Officer Activity Log', view: 'activity-log', icon: ICONS.activities, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'AI Recovery Coach', view: 'recovery-coach', icon: ICONS.lightbulb, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'HR Dashboard', view: 'hr-dashboard', icon: ICONS.user, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Notification Center', view: 'notification-center', icon: ICONS.bell, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Help Requests', view: 'help-requests', icon: ICONS.info, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Reports', view: '', isHeading: true, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Custom Reports', view: 'custom-reports', icon: ICONS.documentReport, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Debtor Portal Preview', view: 'debtor-portal', icon: ICONS.user, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Legal & Finance', view: '', isHeading: true, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Bank Legal Tracker', view: 'legal', icon: ICONS.legal, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Cheque / PDC Tracker', view: 'cheque-tracker', icon: ICONS.payment, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Automation', view: '', isHeading: true, roles: [Role.MANAGER, Role.ADMIN] },
    { label: 'Workflow Rules', view: 'workflow-automation', icon: ICONS.bolt, roles: [Role.MANAGER, Role.ADMIN] },

    // ═══ CEO: Strategic view ═══
    { label: 'Command Center', view: 'ceo-command', icon: ICONS.dashboard, roles: [Role.CEO] },
    { label: 'Executive View 🚀', view: 'exec-dashboard', icon: ICONS.performance, roles: [Role.CEO] },
    { label: 'Crystal Ball 🔮', view: 'crystal-ball', icon: ICONS.eye, roles: [Role.CEO] },
    { label: 'Family Network 🕸️', view: 'family-network', icon: ICONS.team, roles: [Role.CEO] },
    { label: 'Team XP Leaderboard 🏆', view: 'officer-xp', icon: ICONS.performance, roles: [Role.CEO] },
    ...
    { label: 'Vintage Analyzer', view: 'vintage-ai', icon: ICONS.lightbulb, roles: [Role.CEO] },
    { label: 'AI Case Intake', view: 'case-intake', icon: ICONS.plus, roles: [Role.CEO] },
    { label: 'Bank Intelligence', view: 'bank-intel', icon: ICONS.payment, roles: [Role.CEO] },
    ...
    { label: '📥 Import Center', view: 'import-center', icon: ICONS.upload, roles: [Role.CEO] },
    { label: 'Search Cases', view: 'search', icon: ICONS.search, roles: [Role.CEO] },
    { label: 'Skip Tracing (PK)', view: 'pk-tracing', icon: ICONS.search, roles: [Role.CEO] },
    { label: 'Recall Engine', view: 'recall-engine', icon: ICONS.bell, roles: [Role.CEO] },
    { label: 'Connected Debtors', view: 'connected-debtors', icon: ICONS.filter, roles: [Role.CEO] },
    { label: 'Bulk Send', view: 'bulk-comms', icon: ICONS.email, roles: [Role.CEO] },
    { label: 'Pipeline Board', view: 'kanban', icon: ICONS.filter, roles: [Role.CEO] },
    { label: 'Field Visits', view: 'field-visits', icon: ICONS.mapPin, roles: [Role.CEO] },
    { label: 'Summary Report', view: 'summary-report', icon: ICONS.performance, roles: [Role.CEO] },
    { label: 'Status Matrix', view: 'status-matrix', icon: ICONS.filter, roles: [Role.CEO] },
    { label: 'Annual Forecast', view: 'annual-forecast', icon: ICONS.documentReport, roles: [Role.CEO] },
    { label: 'Allocation Report', view: 'allocation-report', icon: ICONS.documentReport, roles: [Role.CEO] },
    ...
    { label: 'User Management', view: 'users', icon: ICONS.team, roles: [Role.CEO] },
    { label: 'Team Floor', view: 'team-floor', icon: ICONS.team, roles: [Role.CEO] },
    { label: 'Officer Activity Log', view: 'activity-log', icon: ICONS.activities, roles: [Role.CEO] },
    { label: 'AI Recovery Coach', view: 'recovery-coach', icon: ICONS.lightbulb, roles: [Role.CEO] },
    { label: 'HR Dashboard', view: 'hr-dashboard', icon: ICONS.user, roles: [Role.CEO] },
    { label: 'Notification Center', view: 'notification-center', icon: ICONS.bell, roles: [Role.CEO] },
    { label: 'Tools', view: '', isHeading: true, roles: [Role.CEO] },
    { label: 'Bank Legal Tracker', view: 'legal', icon: ICONS.legal, roles: [Role.CEO] },
    ...
    { label: 'Search Cases', view: 'search', icon: ICONS.search, roles: [Role.FINANCE] },

    // ═══ ADMIN: same as Manager + system audit (Admin == Manager merged) ═══
    { label: 'System Audit', view: 'system-audit', icon: ICONS.documentReport, roles: [Role.ADMIN, Role.MANAGER] },
];